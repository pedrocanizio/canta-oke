...
window.electronAPI.onStartPlaying((song) => {
  startPlayingKareoke();
});
...
async function updateSelectedSongsList() {
  ...
  let songsHTML =
    "<table><tr><th>Identificador</th><th>Artista</th><th>Nome</th></tr>";
...
async function searchSong(identificador) {
  ...
  try {
    ...
    resultDiv.innerHTML =
      "<p>An error occurred while searching for the song.</p>";
  }
}
...
function startPlayingKareoke(params) {
  navigateTo("video");
}
