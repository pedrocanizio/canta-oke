...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  searchSong: (identificador) =>
    ipcRenderer.invoke("search-song", identificador),
  ...
  updateSong: (id, column, value) =>
    ipcRenderer.invoke("update-song", id, column, value),
  ...
  onUpdateSelectedSongs: (callback) =>
    ipcRenderer.on("update-selected-songs", (event, song) => callback(song)),
  onStartPlaying: (callback) =>
    ipcRenderer.on("start-playing", (event, song) => callback(song)),
});
